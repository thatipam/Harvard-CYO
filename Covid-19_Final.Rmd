...
Hence, the outcome we want to predict is daily cumulative cases and
the features that we will use to predict the outcome are ndays, age group and gender.
&nbsp;
...
kable(rmse_table, caption = "Models Performance")
```
&nbsp;
